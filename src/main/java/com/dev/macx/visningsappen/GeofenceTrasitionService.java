...
public class GeofenceTrasitionService extends IntentService {
   ...
   /* private String getGeofenceTrasitionDetailsandSendNotification(List<Geofence> triggeringGeofences) {
    ...
    private Notification createNotification(String msg, PendingIntent notificationPendingIntent) {
        ...
        String msgAddress = Container.getInstance().objectList[Integer.valueOf(msg)].address;
        String msgContent = Container.getInstance().objectList[Integer.valueOf(msg)].descr;

        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this);

        // check if sound off on setting screen.
